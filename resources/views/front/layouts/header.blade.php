...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="{{$config->favicon ?  asset($config->favicon) : asset('front/assets/favicon.ico')}}" />
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
            <div class="container px-4 px-lg-5">
                ...
                @if($config->icon)
                <img src="{{asset($config->icon)}}" width="100" alt="">
                @else
                {{$config->title}}
                @endif
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto py-4 py-lg-0">
                        ...
                        @endforeach
                        <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="{{route('contact')}}">iletişim</a></li>
                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="site-heading">
                           <h2> @yield('post_title','Clean Blog')</h2>
